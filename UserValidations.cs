...
namespace LambdaPracticeingProblembs
{
    public class UserValidations
    {
        ...
        public const string EMAIL_REGEX = "^[a-z]+([.][a-z]+)*[@][a-z]{2,}[.][a-z]{2,3}([.][a-zA-Z]{2})?$";
        ...
        public const string MOBILENUMBER_REGEX = "^[1-9]{1}[0-9]{1,2}[ ][1-9][0-9]{9}$";
        ...
        public const string PASSWORD_REGEX = "[a-z,A-Z,0-9]{8,16}$";
